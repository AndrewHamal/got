                ...
                <div className="tour_details_leftside_wrapper">
                  <div className="tour_details_heading_wrapper">
                    <div className="tour_details_top_heading">
                      ...
                      <h5><i className="fas fa-map-marker-alt" /> Amazon evergreen forest, Amazon.</h5>
                    </div>
                  ...
                  <div className="tour_details_boxed">
                    ...
                    <div className="tour_details_boxed_inner">
                      ...
                      <ul>
                        ...
                        <li><i className="fas fa-circle" />Visit eight villages showcasing Polynesian culture
                        </li>
                        <li><i className="fas fa-circle" />Complimentary Camel safari, Bonfire, and Cultural
                          Dance at Camp</li>
                        <li><i className="fas fa-circle" />All toll tax, parking, fuel, and driver allowances
                        </li>
                        <li><i className="fas fa-circle" />Comfortable and hygienic vehicle (SUV/Sedan) for
